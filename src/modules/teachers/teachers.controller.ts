...
export const listTeachers: RequestHandler = async (request, response) => {
...
export const getTeacher: RequestHandler = async (request, response) => {
  const { teacherId } = teacherIdSchema.parse(request.params);
  sendSuccess(
    response,
    { teacher: await teachersService.get(request.auth!.schoolId, teacherId) },
    "Teacher retrieved",
  );
};

export const createTeacher: RequestHandler = async (request, response) => {
...
export const updateTeacher: RequestHandler = async (request, response) => {
  const { teacherId } = teacherIdSchema.parse(request.params);
...
export const disableTeacher: RequestHandler = async (request, response) => {
  const { teacherId } = teacherIdSchema.parse(request.params);
