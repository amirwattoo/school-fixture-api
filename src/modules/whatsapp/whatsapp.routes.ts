...
import {
  ...
  getProviderStatus,
  listNotifications,
  markNotificationManuallyConfirmed,
...
whatsappRouter.post(
  "/:notificationId/opened",
  asyncHandler(markNotificationOpened),
);
whatsappRouter.post(
  "/:notificationId/confirm",
  asyncHandler(markNotificationManuallyConfirmed),
);
