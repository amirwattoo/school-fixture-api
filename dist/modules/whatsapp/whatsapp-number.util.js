...
export const isValidE164Number = (value) => E164_PATTERN.test(value);
export const normalizePakistaniWhatsAppNumber = (input) => {
...
export const buildWhatsAppClickToChatUrl = (number, message) => {
...
//# sourceMappingURL=whatsapp-number.util.js.map