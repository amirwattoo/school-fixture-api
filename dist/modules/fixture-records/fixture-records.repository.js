...
export const fixtureRecordsRepository = {
    ...
    history(schoolId, teacherId, filters) {
    ...
    attendanceFixtureCounts(schoolId, filters) {
        const date = filters.from || filters.to
            ? { gte: filters.from, lte: filters.to }
            : undefined;
        return prisma.proxyFixture.findMany({
...
//# sourceMappingURL=fixture-records.repository.js.map