...
import { cancelFixture, generateFixtures, getFixture, getFixtureCandidates, getFixtureScoring, listFixtures, overrideFixture, publishFixtures, } from "./fixtures.controller.js";
export const fixturesRouter = Router();
fixturesRouter.use(authenticate, authorizeRoles("PRINCIPAL", "TIMETABLE_INCHARGE"));
...
fixturesRouter.get("/:fixtureId/candidates", asyncHandler(getFixtureCandidates));
